  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'card': '6px 6px 12px #b8b9be, -6px -6px 12px #ffffff',
        'card-hover': '8px 8px 16px #b8b9be, -8px -8px 16px #ffffff',
        'elevated': '12px 12px 24px #b8b9be, -12px -12px 24px #ffffff',
        'modal': '20px 20px 40px #b8b9be, -20px -20px 40px #ffffff',
      },
      animation: {
